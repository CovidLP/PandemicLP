...
#' \code{pandemicStats} in a list format containing the components described below. 
#'
...
#' \describe{
#'   \item{\code{data}}{
#'   A list containing a data frame with the pandemic data observed, a string with the location name,
#'   and a string indicating whether the cases predicted are confirmed cases or deaths.
#'   }
