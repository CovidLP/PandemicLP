...
#' @return A list containing two plots, long and short. The "long" is the one showing the long term predictions and the "short" is about the shor term predictions. If any of them wasn't plotted due to lack of prediction, its value returns NULL.
#' \item{\code{long}}{
