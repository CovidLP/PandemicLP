...
#' \link[pandemicMCMC]{posterior_predict.stanpandemic} function. It is not necessary to call function
...
#' @seealso \link[pandemicMCMC]{posterior_predict.stanpandemic} and \link[pandemicMCMC]{plot.pandemicPredicted}
#' @examples
...
#' predMG}
#' @export
print.pandemicPredicted = function(object,summaryFun = mean,printPred = "Long",truncView = 3){
