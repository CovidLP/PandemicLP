...
#' 
#' @param object An object of S3 class \code{\link[ = pandemicStats-objects]{pandemicStats}}.
#'
#' @seealso \link{\code{pandemic_stats}}
#' 
#' @export

print.pandemicStats <-function(object, ...){
  
  cat("\n95% Credible Intervals for ",object$data$case_type," cases in ",object$data$location,"\n", sep = "")
