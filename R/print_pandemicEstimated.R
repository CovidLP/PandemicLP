...
#'
#' The \code{print} method for \code{pandemicEstimated} object of class S3 displays a compact summary of the
...
#' In future versions of the package \code{PandemicLP}, the user will be allowed to modify the priors.
...
print.pandemicEstimated=function(x,digits=3,...){
  ...
  cat("\n maximum cumulative total number of cases:",x$config.inputs$use_inputs$p,"*population")
