...
namespace model_pandemicModels_SeasonalsingleWave_poisson_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 40, column 2 to column 10)",
                                                      ...
                                                      " (in 'string', line 51, column 4 to column 174)",
                                                      " (in 'string', line 50, column 15 to line 52, column 1)",
                                                      " (in 'string', line 50, column 2 to line 52, column 1)",
                                                      ...
                                                      " (in 'string', line 65, column 2 to column 34)",
                                                      ...
                                                      " (in 'string', line 16, column 3 to column 25)",
                                                      " (in 'string', line 17, column 3 to column 24)",
                                                      " (in 'string', line 18, column 3 to column 17)",
                                                      " (in 'string', line 19, column 3 to column 30)",
                                                      " (in 'string', line 20, column 4 to column 26)",
                                                      " (in 'string', line 21, column 3 to column 24)",
                                                      " (in 'string', line 22, column 4 to column 30)",
                                                      " (in 'string', line 23, column 3 to column 30)",
                                                      " (in 'string', line 24, column 3 to column 27)",
                                                      " (in 'string', line 25, column 3 to column 26)",
                                                      " (in 'string', line 26, column 4 to column 28)",
                                                      " (in 'string', line 27, column 3 to column 26)",
                                                      " (in 'string', line 28, column 3 to column 27)",
                                                      " (in 'string', line 29, column 3 to column 26)",
                                                      " (in 'string', line 30, column 3 to column 16)",
                                                      " (in 'string', line 31, column 3 to column 28)",
                                                      " (in 'string', line 32, column 4 to column 28)",
                                                      " (in 'string', line 33, column 3 to column 26)",
                                                      " (in 'string', line 34, column 3 to column 25)",
                                                      " (in 'string', line 35, column 3 to column 24)",
                                                      " (in 'string', line 48, column 30 to column 31)"};
#include <stan_meta_header.hpp>
class model_pandemicModels_SeasonalsingleWave_poisson final : public model_base_crtp<model_pandemicModels_SeasonalsingleWave_poisson> {
private:
  int n;
  std::vector<int> y;
  double pop;
...
public:
  ~model_pandemicModels_SeasonalsingleWave_poisson() { }
  
  inline std::string model_name() const final { return "model_pandemicModels_SeasonalsingleWave_poisson"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_pandemicModels_SeasonalsingleWave_poisson(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_pandemicModels_SeasonalsingleWave_poisson_namespace::model_pandemicModels_SeasonalsingleWave_poisson";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_pandemicModels_SeasonalsingleWave_poisson_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      if (jacobian__) {
        current_statement__ = 2;
        f = stan::math::lb_constrain(f, 1, lp__);
      } else {
        current_statement__ = 2;
        f = stan::math::lb_constrain(f, 1);
      }
      local_scalar_t__ b1;
      b1 = DUMMY_VAR__;
      ...
      for (int t = 1; t <= n; ++t) {
        ...
        assign(mu, cons_list(index_uni(t), nil_index_list()),
          (((stan::math::exp(
               ((((stan::math::log(f) + stan::math::log(a)) +
                   stan::math::log(c)) - (c * t)) -
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_pandemicModels_SeasonalsingleWave_poisson_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      current_statement__ = 2;
      f_free__ = stan::math::lb_free(f, 1);
      double b1;
      b1 = std::numeric_limits<double>::quiet_NaN();
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"c\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"f\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"b1\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"a\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"d_1\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"d_2\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"d_3\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"b\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"array\",\"length\":" << n << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"}]";
    return s__.str();
...
using stan_model = model_pandemicModels_SeasonalsingleWave_poisson_namespace::model_pandemicModels_SeasonalsingleWave_poisson;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_pandemicModels_SeasonalsingleWave_poisson_namespace::profiles__;
}
#endif
#endif
