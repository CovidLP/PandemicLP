...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_pandemicModels_SeasonalsingleWave_poisson");
    reader.add_event(83, 81, "end", "model_pandemicModels_SeasonalsingleWave_poisson");
    return reader;
}
#include <stan_meta_header.hpp>
class model_pandemicModels_SeasonalsingleWave_poisson
  : public stan::model::model_base_crtp<model_pandemicModels_SeasonalsingleWave_poisson> {
private:
        int n;
        std::vector<int> y;
        double pop;
...
public:
    ...
    std::string model_name() const {
        return "model_pandemicModels_SeasonalsingleWave_poisson";
    }
...
typedef model_pandemicModels_SeasonalsingleWave_poisson_namespace::model_pandemicModels_SeasonalsingleWave_poisson stan_model;
#ifndef USING_R
