...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 62, column 2 to column 28)",
                                                      " (in 'string', line 65, column 2 to column 39)",
                                                      " (in 'string', line 66, column 2 to column 35)",
                                                      " (in 'string', line 68, column 4 to column 14)",
                                                      " (in 'string', line 70, column 6 to line 76, column 10)",
                                                      " (in 'string', line 69, column 28 to line 77, column 5)",
                                                      " (in 'string', line 69, column 4 to line 77, column 5)",
                                                      " (in 'string', line 67, column 15 to line 78, column 3)",
                                                      ...
                                                      " (in 'string', line 27, column 3 to column 25)",
                                                      " (in 'string', line 28, column 3 to column 24)",
                                                      " (in 'string', line 29, column 3 to column 17)",
                                                      " (in 'string', line 30, column 3 to column 30)",
                                                      " (in 'string', line 31, column 4 to column 26)",
                                                      " (in 'string', line 32, column 3 to column 24)",
                                                      " (in 'string', line 33, column 4 to column 30)",
                                                      " (in 'string', line 34, column 3 to column 30)",
                                                      " (in 'string', line 35, column 3 to column 27)",
                                                      " (in 'string', line 36, column 3 to column 26)",
                                                      " (in 'string', line 37, column 4 to column 28)",
                                                      " (in 'string', line 38, column 3 to column 26)",
                                                      " (in 'string', line 39, column 3 to column 27)",
                                                      " (in 'string', line 40, column 3 to column 26)",
                                                      " (in 'string', line 41, column 3 to column 16)",
                                                      " (in 'string', line 42, column 3 to column 28)",
                                                      " (in 'string', line 43, column 4 to column 28)",
                                                      " (in 'string', line 44, column 3 to column 26)",
                                                      " (in 'string', line 45, column 3 to column 25)",
                                                      " (in 'string', line 46, column 3 to column 24)",
                                                      " (in 'string', line 49, column 9 to column 16)",
                                                      " (in 'string', line 50, column 44 to column 51)",
                                                      " (in 'string', line 52, column 18 to column 25)",
                                                      " (in 'string', line 54, column 20 to column 27)",
                                                      " (in 'string', line 55, column 20 to column 27)",
                                                      " (in 'string', line 56, column 20 to column 27)",
                                                      " (in 'string', line 58, column 18 to column 25)",
                                                      " (in 'string', line 59, column 9 to column 16)",
                                                      " (in 'string', line 62, column 18 to column 19)",
                                                      " (in 'string', line 65, column 18 to column 25)",
                                                      " (in 'string', line 66, column 29 to column 30)",
...
class model_pandemicModels_multiWave_negbin final : public model_base_crtp<model_pandemicModels_multiWave_negbin> {
private:
  int n;
  std::vector<int> y;
  double pop;
...
public:
  ...
  inline std::string model_name() const final { return "model_pandemicModels_multiWave_negbin"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_pandemicModels_multiWave_negbin_namespace::log_prob";
(void) function__;  // suppress unused var warning
...
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"b1\",\"type\":{\"name\":\"vector\",\"length\":" << nCurves << "},\"block\":\"parameters\"},{\"name\":\"a\",\"type\":{\"name\":\"array\",\"length\":" << nCurves << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"c\",\"type\":{\"name\":\"array\",\"length\":" << nCurves << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"d_1\",\"type\":{\"name\":\"array\",\"length\":" << nCurves << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"d_2\",\"type\":{\"name\":\"array\",\"length\":" << nCurves << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"d_3\",\"type\":{\"name\":\"array\",\"length\":" << nCurves << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"vector\",\"length\":" << nCurves << "},\"block\":\"parameters\"},{\"name\":\"delta\",\"type\":{\"name\":\"vector\",\"length\":" << nCurves << "},\"block\":\"parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"vector\",\"length\":" << n << "},\"block\":\"parameters\"},{\"name\":\"b\",\"type\":{\"name\":\"vector\",\"length\":" << nCurves << "},\"block\":\"transformed_parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" << n << "},\"block\":\"transformed_parameters\"}]";
    return s__.str();
...
using stan_model = model_pandemicModels_multiWave_negbin_namespace::model_pandemicModels_multiWave_negbin;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_pandemicModels_multiWave_negbin_namespace::profiles__;
}
#endif
#endif
