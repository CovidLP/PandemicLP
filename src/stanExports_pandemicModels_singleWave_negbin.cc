...
#include "stanExports_pandemicModels_singleWave_negbin.h"

RCPP_MODULE(stan_fit4pandemicModels_singleWave_negbin_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_pandemicModels_singleWave_negbin")
