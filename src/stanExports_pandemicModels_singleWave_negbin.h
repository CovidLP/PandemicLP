...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_pandemicModels_singleWave_negbin");
    reader.add_event(79, 77, "end", "model_pandemicModels_singleWave_negbin");
    return reader;
}
...
genLog(const int& t,
    ...
    try {
        ...
        stan::math::assign(logV,((((stan::math::log(f) + stan::math::log(a)) + stan::math::log(c)) - (c * t)) - ((f + 1) * stan::math::log((b + stan::math::exp((-(c) * t)))))));
...
class model_pandemicModels_singleWave_negbin
  : public stan::model::model_base_crtp<model_pandemicModels_singleWave_negbin> {
private:
        int n;
        std::vector<int> y;
        double pop;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "fTrunc", "double", context__.to_vec());
            fTrunc = double(0);
            vals_r__ = context__.vals_r("fTrunc");
            pos__ = 0;
            fTrunc = vals_r__[pos__++];
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        f = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(fTrunc, f);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                f = in__.scalar_lb_constrain(fTrunc, lp__);
            else
                f = in__.scalar_lb_constrain(fTrunc);
            current_statement_begin__ = 38;
            local_scalar_t__ a;
            ...
            for (int t = 1; t <= n; ++t) {
                ...
                stan::model::assign(mu, 
                            ...
                            (((genLog(t, a, b, c, f, 0, pstream__) * pow(d_1, (logical_eq(modulus((t - w1), 7), 0) * logical_gt(w1, 0)))) * pow(d_2, (logical_eq(modulus((t - w2), 7), 0) * logical_gt(w2, 0)))) * pow(d_3, (logical_eq(modulus((t - w3), 7), 0) * logical_gt(w3, 0)))), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.push_back(b1);
        double f = in__.scalar_lb_constrain(fTrunc);
        vars__.push_back(f);
    ...
    std::string model_name() const {
        return "model_pandemicModels_singleWave_negbin";
    }
...
typedef model_pandemicModels_singleWave_negbin_namespace::model_pandemicModels_singleWave_negbin stan_model;
#ifndef USING_R
