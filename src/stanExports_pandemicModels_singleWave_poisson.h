...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 51, column 4 to column 20)",
                                                      ...
                                                      " (in 'string', line 13, column 3 to column 25)",
                                                      " (in 'string', line 14, column 3 to column 24)",
                                                      " (in 'string', line 15, column 3 to column 17)",
                                                      " (in 'string', line 16, column 3 to column 30)",
                                                      " (in 'string', line 17, column 4 to column 26)",
                                                      " (in 'string', line 18, column 3 to column 24)",
                                                      " (in 'string', line 19, column 4 to column 30)",
                                                      " (in 'string', line 20, column 3 to column 30)",
                                                      " (in 'string', line 21, column 3 to column 27)",
                                                      " (in 'string', line 22, column 3 to column 26)",
                                                      " (in 'string', line 23, column 4 to column 28)",
                                                      " (in 'string', line 24, column 3 to column 26)",
                                                      " (in 'string', line 25, column 3 to column 27)",
                                                      " (in 'string', line 26, column 3 to column 26)",
                                                      " (in 'string', line 27, column 3 to column 16)",
                                                      " (in 'string', line 28, column 3 to column 28)",
                                                      " (in 'string', line 29, column 4 to column 28)",
                                                      " (in 'string', line 30, column 3 to column 26)",
                                                      " (in 'string', line 31, column 3 to column 25)",
                                                      " (in 'string', line 32, column 3 to column 24)",
                                                      " (in 'string', line 42, column 30 to column 31)"};
#include <stan_meta_header.hpp>
class model_pandemicModels_singleWave_poisson final : public model_base_crtp<model_pandemicModels_singleWave_poisson> {
private:
  int n;
  std::vector<int> y;
  double pop;
...
public:
  ...
  inline std::string model_name() const final { return "model_pandemicModels_singleWave_poisson"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_pandemicModels_singleWave_poisson_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      if (jacobian__) {
        current_statement__ = 2;
        b1 = stan::math::lb_constrain(b1, -30, lp__);
      } else {
        current_statement__ = 2;
        b1 = stan::math::lb_constrain(b1, -30);
      }
      local_scalar_t__ a;
      a = DUMMY_VAR__;
...
(void) function__;  // suppress unused var warning
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      current_statement__ = 2;
      b1_free__ = stan::math::lb_free(b1, -30);
      double a;
      a = std::numeric_limits<double>::quiet_NaN();
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"f\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"b1\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"a\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"c\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"b\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"array\",\"length\":" << n << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"}]";
    return s__.str();
...
using stan_model = model_pandemicModels_singleWave_poisson_namespace::model_pandemicModels_singleWave_poisson;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_pandemicModels_singleWave_poisson_namespace::profiles__;
}
#endif
#endif
