...
namespace model_poisson_static_generalized_logistic_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_poisson_static_generalized_logistic");
    reader.add_event(53, 51, "end", "model_poisson_static_generalized_logistic");
    return reader;
}
#include <stan_meta_header.hpp>
class model_poisson_static_generalized_logistic
  : public stan::model::model_base_crtp<model_poisson_static_generalized_logistic> {
private:
        int n;
        std::vector<int> y;
        double pop;
        double p;
public:
    model_poisson_static_generalized_logistic(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_poisson_static_generalized_logistic_namespace::model_poisson_static_generalized_logistic";
    ...
    ~model_poisson_static_generalized_logistic() { }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_poisson_static_generalized_logistic_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_poisson_static_generalized_logistic";
    }
...
typedef model_poisson_static_generalized_logistic_namespace::model_poisson_static_generalized_logistic stan_model;
#ifndef USING_R
